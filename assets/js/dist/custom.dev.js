...
var resetBtn = document.querySelector('.frame'); // 모든 버튼 및 섹션에서 'active' 클래스 제거
...
resetBtn.addEventListener('click', resetActiveClasses); // 내비게이션 버튼 클릭 이벤트 추가

navBtns.forEach(function (btn, indx) {
  btn.addEventListener('click', function () {
    return handleNavButtonClick(indx);
  });
});